...
function LoginForm(
  { auth, switchToSignUp, initEmail, initPassword }: PropsWithChildren<Props>,
) {
    ...
    return signInWithEmailAndPassword(auth, data.email, data.password)
      .catch((e) => {
        const defaultMessage =
          "Something went wrong when trying to log you in. Please try again later.";
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="authForm">
        ...
        <div className="authFormFooter">
          <button
            ...
            onClick={() => switchToSignUp(getValues())}
          >
            Sign up instead
          </button>
