...
function SignUpForm(
  { auth, switchToLogIn, initEmail, initPassword }: PropsWithChildren<Props>,
) {
    ...
    return createUserWithEmailAndPassword(auth, data.email, data.password)
      .catch((e) => {
        const defaultMessage =
          "Something went wrong when trying to sign you up. Please try again later.";
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="authForm">
        ...
        <div className="authFormFooter">
          <button
            ...
            onClick={() => switchToLogIn(getValues())}
          >
            I have an account
          </button>
