  ...
  return (
    <form id={id} onSubmit={handleSubmit(onSubmit)} className="recipeForm">
      ...
      <section className="recipeFormMeta">
        ...
        <input
          {...register("timeframe", timeframeValidation)}
          type="text"
          placeholder="-"
          autoComplete="off"
        />
        ...
        <input
          {...register("makes", makesValidation)}
          type="text"
          placeholder="-"
          autoComplete="off"
        />
        ...
        <input
          {...register("servings", servingsValidation)}
          type="text"
          placeholder="-"
          autoComplete="off"
        />
      ...
      <div className="notes">
        ...
        <TextAreaAutoHeight
          {...register("notes", notesValidation)}
      ...
      <IngredientsField
        {...{ control, register, getValues, setValue, trigger }}
      />
      ...
      <div className="instructions">
        ...
        <TextAreaAutoHeight
          {...register("instructions", instructionsValidation)}
          lineHeight={standardLineHeight}
          defaultLines={1}
        />
