...
function IngredientsField({ arrayHelpers }: Props) {
    const {
        ...
        setFieldValue,
        handleBlur
    } = useFormikContext<RecipeFormData>();
    ...
    const allIngredients = useRef<RecipeInputIngredient[]>(concatIngredients(values));
    ...
    const percentageFromVal = (ingredient: RecipeInputIngredient): number | undefined => {
